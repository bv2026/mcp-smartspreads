...
class PublicationContractTests(unittest.TestCase):
    ...
    def test_publish_issue_writes_contract_files_and_db_records(self) -> None:
        ...
        self.assertEqual(watchlist_payload["watchlist"][0]["spread_type"], "calendar")
        self.assertEqual(watchlist_payload["watchlist"][0]["spread_expression"], "SELL (CU26 - CZ26)")
        self.assertIn("one spread", watchlist_payload["watchlist"][0]["reporting_rule"])
